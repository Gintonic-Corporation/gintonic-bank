...
/**
 * Új ügyfél létrehozását kezelõ osztály
 * @author Hujber Ádám
 *
 */
public class NewClientController implements Initializable{
	...
	/**
	 * Új ügyfél létrehozását teszi lehetõvé a függvény. Amennyiben nincs kitöltve minden adat Alert-el jelzi azt a felhasználónak. Bármi egyéb hibát(típuseltérésbõl fakadót pl) hasonlóan jelez.
	 * @param event
	 */
