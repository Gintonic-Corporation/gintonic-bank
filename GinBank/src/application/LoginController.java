...
public class LoginController implements Initializable {
	...
	public void loginAttempt(ActionEvent e){
		...
		String url = "jdbc:sqlserver://DESKTOP-NS687T6:1433; databaseName=testDB; encrypt=true; trustServerCertificate=true; integratedSecurity=true;";
		try (Connection con = DriverManager.getConnection(url); Statement stmt = con.createStatement();){
	        ...
	        while(rs.next())
	        {
	        	if(rs.getString("uname").equals(user) && rs.getString("pass").equals(pass))
	        	{
	        		if(rs.getByte("isadmin")==1)
	        		{
