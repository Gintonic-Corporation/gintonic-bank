...
/**
 * Különbözõ ügyféladatok lekérdezését, módosítását végzõ osztály
 * @author Hujber Ádám
 *
 */
public class QueryController implements Initializable{
	...
	/**
	 * Már létezõ ügyfél datainak módosítását teszi lehetõvé.
	 */
	...
	/**
	 * A keresési lista frissítését teszi lehetõvé, ha módosítás történt
	 */
