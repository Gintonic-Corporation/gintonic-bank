...
/**
 * Különbözõ menüpontok közötti váltást megvalósító osztály
 * @author Hujber Ádám
 *
 */
public class SceneSwitcher implements Initializable{
	...
	private Button pwdModify;
	 ...
	 /**
	  * Login ablakból átvált a fõmenüre.
	  * @param event
	  */
	 @FXML
	 ...
	 /**
	  * beállítja a bejelentkezett személy felhasználónevét és jogosultságát
	  * @param u felhasználónév
	  * @param a admin jogosultságú-e
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja az új ügyfél hozzáadását lehetõvé tevõ ablakot
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja az adatkezelõ ablakot
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja az új számla létrehozását lehetõvé tevõ ablakot
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja az utalás kezdeményezését lehetõvé tevõ ablakot
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja a számlatörténet ablakot
	  */
	 ...
	 /**
	  * Megfelelõ gomb aktiválása esetén megnyitja a befizetést/kifizetést kezelõ ablakot
	  */
	 ...
	 /**
	  * Menüben lévõ felhasználó hozzáadása gomb megnyomására új felhasználó rögzítését teszi lehetõvé. Ehhez külön ablakba bekéri az adatokat.
	  */
	...
	/**
	 * Jelszó megváltoztatását teszi lehetõvé. Ehhez bekéri a régi jelszót, majd az új jelszót kétszer. Ezt követõen ellenõrzi a helyességét és módosítja
	 */
		...
		dialog.setResultConverter((ButtonType button) -> {
            if (button == ButtonType.OK) {
                ...
                try{
					...
					a.setHeaderText("Sikeres jelszóváltoztatás!");
					a.setContentText("A felhasználói jelszó sikeresen módosult.");
					a.show();
				} catch (Exception e) {
